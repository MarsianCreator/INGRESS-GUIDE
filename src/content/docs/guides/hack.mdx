...
<CardGrid>
  <Card title="便捷Hack（无需key）" icon="right-arrow">
    ![](../../../assets/hack5.png)通过长按Portal向右上滑动以实现无需key的快捷hack。
  </Card>
  <Card title="便捷Hack（需要key）" icon="left-arrow">
...
<CardGrid>
  ...
  - 产出物品内容：
    ...
    - [部分Mod](/INGRESS-GUIDE/reference/farmmod/#ito-en-transmuter)会影响产出物资类型。
